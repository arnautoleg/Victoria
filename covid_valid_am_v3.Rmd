...
secondary <- read_xlsx("pacienti covid (1).xlsx", 3)
...
# Assuming you have a data frame called df with 'id' and 'value' columns
# Pivot the data frame from long to wide format
wide_df <- pivot_wider(secondary, id_cols = id, names_from = code, values_from = code)

# Print the wide format data frame
print(wide_df)

wide_df <- ifelse(is.na(wide_df), 0, 1)
